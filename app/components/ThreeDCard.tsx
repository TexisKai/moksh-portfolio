...
export const CardBody = ({
  ...
  return (
    <div
      className={cn(
        "h-[350px] w-[350px] relative rounded-xl overflow-hidden border border-neutral-800 bg-neutral-900 shadow-lg [transform-style:preserve-3d]",
        className
      )}
    >
      {children}
